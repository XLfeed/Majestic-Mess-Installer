...
; Path to the installer sound file
; Note: Sound file will be embedded in the installer
...
; Include installer sound file
Source: .\INSTALLERFILES\install_sound.wav; DestDir: {tmp}; Flags: dontcopy
